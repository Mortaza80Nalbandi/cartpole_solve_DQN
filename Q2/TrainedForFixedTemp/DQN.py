...
class DQN_Agent:
    ...
    def __init__(self, env, temperature,clip_grad_norm, learning_rate, discount, memory_capacity):
    ...
    def select_action(self, state):
        ...
        exp_probabilities = np.exp(Q_values/ self.temperature)
...
if __name__ == '__main__':
    ...
    RL_hyperparams = {
        ...
        "temperature": 0.999 if train_mode else -1,
